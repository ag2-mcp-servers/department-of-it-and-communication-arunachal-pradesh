...
#   timestamp: 2025-06-28T14:57:30+00:00
...
class CertificateParameters(BaseModel):
    ...
    eILPAppId: str = Field(..., description='Application ID', examples=['94XXX'])
    eILPContactNumber: str = Field(
        ..., description='Contact Number', examples=['98765XXXXX']
    )
...
class IlpmtCertificatePostRequest(BaseModel):
...
class IlpmtCertificatePostResponse(BaseModel):
...
class IlpmtCertificatePostResponse1(BaseModel):
...
class IlpmtCertificatePostResponse2(BaseModel):
...
class IlpmtCertificatePostResponse3(BaseModel):
...
class IlpmtCertificatePostResponse4(BaseModel):
...
class IlpmtCertificatePostResponse5(BaseModel):
...
class IlpmtCertificatePostResponse6(BaseModel):
